...
:: Android packaging
set AND_CERT_NAME="plurkairmobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\plurkairmobile.p12
...
set IOS_PROVISION=cert\plurkairmobile.mobileprovision
...
set APP_ID=com.petewarrior.plurkkarmaairmobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=plurkairmobile
